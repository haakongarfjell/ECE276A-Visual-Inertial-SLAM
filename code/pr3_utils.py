...
def visualize_trajectory_2d(pose,points1,points2,path_name="Unknown",show_ori=False):
    '''
    ...
    ax.scatter(points1[0,:],points1[1,:],s=1,label="landmarks",c='g')
    ax.scatter(points2[0,:],points2[1,:],s=1,label="landmarks",c='b')
